...
export default function Footer() {
  return (
    <footer className="relative flex flex-col items-center overflow-hidden bg-cyan-900 py-20 md:py-40">
          ...
          <div className="flex flex-wrap items-center justify-between md:flex-nowrap">
            <div className="flex w-full justify-center space-x-12 text-gray-300 sm:w-7/12 md:justify-start">
              ...
              <ul role="list" className="space-y-8">
                <li>
                  <a href="#" className="flex items-center space-x-3 transition hover:text-sky-400">
      ...
      <div aria-hidden="true" className="absolute inset-0 flex h-full items-center">
        <div
          aria-hidden="true"
          className="bg-layers bg-scale m-auto h-56 w-56 rounded-full bg-gradient-to-r from-cyan-400 via-blue-500 to-purple-600 blur-xl md:h-[30rem] md:w-[30rem] md:blur-3xl"
        />
      </div>
      <div aria-hidden="true" className="absolute inset-0 h-full w-full bg-[#020314] opacity-80" />
    </footer>
  );
}
